...
//de-left
    if(ho2_1 > 250) {
        strokeWeight(20);
        fill(255,255,0);        
        rect(0, ho1, vo1, ho2_1 - ho1);
        strokeWeight(10);
        fill(255,0,0);        
        rect(0, ho4_1, vo3_1, height - ho4_1);
    }else if(ho2_1 <= 250 && ho2_1 > 150) {
        strokeWeight(10);
        fill(0);        
        rect(0, ho1, vo1, ho2_1 - ho1);
        strokeWeight(10);
        fill(0,0,255);        
        rect(vo5_1,ho2_1,vo3_1-vo5_1,ho4_1-ho2_1);
    }else if(ho2_1 <= 250) {
        strokeWeight(10);
        fill(255);        
        rect(0, ho1, vo1, ho2_1 - ho1);
    }
    if (vo3_1 > 260 && vo3_1 <= 350) {
        strokeWeight(10);
        fill(0);        
        rect(vo3_1,ho2_1,vo1-vo3_1,height-ho2_1);
        strokeWeight(10);
        fill(0,0,255);        
        rect(vo5_1,ho2_1,vo3_1-vo5_1,ho4_1-ho2_1);
    } else if( vo3_1 <= 350 || ho4_1 > 600) {
        strokeWeight(20);
        fill(255,180,0);        
        rect(vo3_1,ho2_1,vo1-vo3_1,height-ho2_1);
        strokeWeight(10);
...
//de_right
    if (ho2_1 < 400) {        
        fill(255,0,0);
        strokeWeight(10);
        rect(vo1,ho2_2,vo3_2-vo1, height-ho2_2);        
        fill(255);
        strokeWeight(10);
        rect(vo1, ho2_1, vo5_2-vo1, ho4_2-ho2_1);
    }else if (ho2_1 >=400 && ho2_1 < 600) {        
        fill(255);
        strokeWeight(10);
        rect(vo1,ho2_2,vo3_2-vo1, height-ho2_2);        
        fill(255,0,0);
        ...
        fill(255);
        strokeWeight(10);
        rect(vo1, ho1, vo5_2 - vo1, ho6 - ho1);
    }else {        
        fill(255,0,0);
        strokeWeight(10);
        rect(vo1,ho2_2,vo3_2-vo1, height-ho2_2);      
    ...
    if (ho4_2 < 400 || ho4_2 >600) {        
        fill(0,0,255);
        strokeWeight(10);
        rect(vo1, ho4_2,vo3_2-vo1,ho2_2-ho4_2);        
        fill(100);
        strokeWeight(10);
        rect(vo3_3,ho2_2, width-vo3_3,height-ho2_2);
    }else if(vo3_2 > 400) {           
        rect(0, ho1, vo1, ho1-ho2_1);
        fill(180);
        strokeWeight(10);
        rect(vo3_3,ho1, width-vo3_3,ho2_2-ho1);   
    }else {        
        fill(255);
        strokeWeight(20);
        rect(vo1, ho4_2,vo3_2-vo1,ho2_2-ho4_2);        
    ...
    fill(255);
    strokeWeight(20);
    rect(vo1, ho2_2, vo3_3-vo1, height-ho2_2);      
    fill(255);
    strokeWeight(10);
    rect(vo3_2, ho1, width-vo3_2, ho2_2-ho1); 
}
